...
if (cardSprite == spr_tolkien) global.cardDescription = "Tolky"; 
else if (cardSprite == spr_leonard) global.cardDescription = "Leon"; 
else if (cardSprite == spr_chaussard) global.cardDescription = "Chauss"; 
else global.cardDescription = "None"; 
